...
const en = {
  ...
  password: {
    ...
    reqLower: "Atleast one lowercase letter",
    reqDigit: "Atleast one number",
  ...
  flabel: {
    ...
    travelDocNo: "Travel document number",
    travelIssuedDate: "Travel document issued date",
    travelExpiryDate: "Travel document expiry date",
    travelIssueCountry: "Travel document issuing country",
    travelIssueAuthority: "Travel document issuing authority",
    campName: "Camp name",
    properties: "Dwelling description",
  ...
  registry: {
    ...
    fatherTooYoung: "Father must be at least 12 years older than the applicant.",
    motherTooYoung: "Mother must be at least 12 years older than the applicant.",
    fatherAgeError: "Father must be at least 18 years old.",
    motherAgeError: "Mother must be at least 18 years old.",
    ...
    orgInvalid: "Only letters, numbers and basic punctuation are allowed.",
    parentCertRequired: "Upload at least one parent's birth certificate (father or mother).",
    ...
    docNumberRange: "Document number must be {min}–{max} characters.",
    ...
    familyGateMarriedLocked: "Because your marital status is \"{status}\" (Step 1), you must provide spouse and family information. This cannot be skipped.",
    familyGateWidowedLocked: "Because your marital status is \"{status}\" (Step 1), you must provide your late spouse's details. This cannot be skipped.",
    ...
    s5Intro:
      "Provide at least one emergency contact with his/her full details. These individuals may be contacted in urgent situations.",
    ...
    stagePendingEnrollment: "Pending Enrollment",
    ...
    statusRejectedMsg:
      "Your registration was rejected by the reviewing officer. Please contact the Immigration Services Department for details.",
    statusIncompleteMsg:
  ...
  fields: {
    ...
    specialMark: "Special Mark",
    languageSpoken: "Language Spoken",
    phOtherNames: "Other names (optional)",
    phTribe: "Tribe (optional)",
    phEyeColor: "e.g. Brown",
    ...
    travelExpiryDate: "Expiry Date",
    travelIssueCountry: "Issuing Country",
    travelIssueAuthority: "Issuing Authority",
    phTravelIssueAuthority: "e.g. Somali Immigration Authority",
    campSection: "Camp / Settlement",
  ...
  officer: {
    casesTitle: "My Registrations",
    casesSubtitle: "Active registration cases.",
    casesLoading: "Loading your cases…",
    casesError: "Could not load your cases. Please try again.",
    casesEmpty: "You have no active registrations.",
    casesEmptyHint: "Start a new registration to begin the process.",
    startNew: "New Registration",
    resume: "Resume",
    caseStage: "Stage {n} of 9",
    caseCreated: "Started {date}",
    colName: "Applicant",
    colType: "Type",
    colStage: "Progress",
    colStatus: "Status",
    ...
    statusPendingEnrollment: "Pending Enrollment",
    ...
    colOfficer: "Registered By",
    colStation: "Station",
    viewDetails: "View",
    searchAllPlaceholder: "Enter Subject ID to search…",
    searchBtn: "Search",
    searching: "Searching…",
    searchEmpty: "No registration found for this Subject ID.",
    searchHint: "Enter a Subject ID to look up any registered person across all stations.",
...
const sw: typeof en = {
  ...
  password: {
    ...
    reqLower: "Angalau herufi ndogo moja",
    reqDigit: "Angalau namba moja",
  ...
  flabel: {
    ...
    permStreet: "Mtaa wa makazi ya kudumu",
    ...
    languageSpoken: "Lugha inayozungumzwa",
    heightCm: "Urefu",
    specialMark: "Alama maalum",
    ...
    travelDocNo: "Namba ya hati ya safari",
    travelIssuedDate: "Tarehe ya kutolewa hati ya safari",
    travelExpiryDate: "Tarehe ya kuisha hati ya safari",
    travelIssueCountry: "Nchi iliyotoa hati ya safari",
    travelIssueAuthority: "Mamlaka iliyotoa hati ya safari",
    campName: "Jina la kambi",
    properties: "Maelezo ya makazi",
  ...
  registry: {
    ...
    fatherTooYoung: "Baba lazima awe mkubwa kwa angalau miaka 12 kuliko mwombaji.",
    motherTooYoung: "Mama lazima awe mkubwa kwa angalau miaka 12 kuliko mwombaji.",
    fatherAgeError: "Baba lazima awe na umri wa angalau miaka 18.",
    motherAgeError: "Mama lazima awe na umri wa angalau miaka 18.",
    ...
    heightRange: "Urefu lazima uwe kati ya sentimita {min} na {max}.",
    orgInvalid: "Herufi, namba na alama za kawaida pekee ndizo zinazoruhusiwa.",
    parentCertRequired: "Pakia angalau cheti kimoja cha kuzaliwa cha mzazi (baba au mama).",
    ...
    docNumberRange: "Namba ya hati lazima iwe na herufi/tarakimu {min}–{max}.",
    ...
    familyGateMarriedLocked: "Kwa sababu hali yako ya ndoa ni \"{status}\" (Hatua ya 1), unapaswa kutoa taarifa za mwenzi na familia. Haiwezi kurukwa.",
    familyGateWidowedLocked: "Kwa sababu hali yako ya ndoa ni \"{status}\" (Hatua ya 1), unapaswa kutoa taarifa za marehemu mwenzi wako. Haiwezi kurukwa.",
    ...
    s5Intro:
      "Toa angalau mtu mmoja wa dharura na maelezo yake kamili. Watu hawa wanaweza kuwasiliana nao katika hali za dharura.",
    ...
    clauseText:
      "Natamka kwamba taarifa zote nilizotoa katika fomu hii ya usajili ni za kweli, kamili na sahihi kwa ufahamu wangu wote. Naelewa kuwa taarifa zozote za uongo au kuficha ukweli muhimu kunaweza kusababisha kukataliwa kwa maombi yangu au mashtaka ya jinai chini ya Sheria ya Usalama wa Taifa na Utambulisho wa Kidijitali.",
    ...
    stageSubmitted: "Ombi limewasilishwa",
    stagePendingEnrollment: "Inasubiri kuandikishwa",
    stageApproved: "Ombi limeidhinishwa",
    ...
    statusRejectedMsg:
      "Usajili wako umekataliwa na afisa mkaguzi. Tafadhali wasiliana na Idara ya Uhamiaji kwa maelezo zaidi.",
    statusIncompleteMsg:
  ...
  fields: {
    ...
    physicalCharacteristics: "Sifa za Kimwili",
    otherNames: "Majina Mengine",
    tribe: "Kabila",
    eyeColor: "Rangi ya Macho",
    hairColor: "Rangi ya Nywele",
    ...
    specialMark: "Alama Maalum",
    languageSpoken: "Lugha Inayozungumzwa",
    phOtherNames: "Majina mengine (hiari)",
    phTribe: "Kabila (hiari)",
    phEyeColor: "mf. Kahawia",
    ...
    travelExpiryDate: "Tarehe ya Kuisha",
    travelIssueCountry: "Nchi Iliyotoa",
    travelIssueAuthority: "Mamlaka Iliyotoa",
    phTravelIssueAuthority: "mf. Mamlaka ya Uhamiaji ya Somalia",
    campSection: "Kambi / Makazi",
  ...
  officer: {
    casesTitle: "Usajili Wangu",
    casesSubtitle: "Kesi za usajili zinazoendelea zilizopewa kwako.",
    casesLoading: "Inapakia kesi zako…",
    casesError: "Imeshindwa kupakia kesi zako. Tafadhali jaribu tena.",
    casesEmpty: "Huna usajili unaoendelea.",
    casesEmptyHint: "Anza usajili mpya kuanzisha mchakato.",
    startNew: "Usajili Mpya",
    resume: "Endelea",
    caseStage: "Hatua {n} kati ya 9",
    caseCreated: "Ilianzishwa {date}",
    colName: "Mwombaji",
    colType: "Aina",
    colStage: "Maendeleo",
    colStatus: "Hali",
    colActions: "Vitendo",
    statusPending: "Inaendelea",
    statusPendingEnrollment: "Inasubiri Usajili",
    ...
    colDate: "Tarehe",
    declaredTitle: "Watu Waliosajiliwa",
    declaredSubtitle: "Angalia usajili uliotangazwa unasubiri uandikishaji.",
    tabMine: "Usajili Wangu",
    tabStation: "Usajili wa Kituo",
    tabSearch: "Tafuta Wote",
    declaredLoading: "Inapakia usajili…",
    declaredError: "Imeshindwa kupakia usajili. Tafadhali jaribu tena.",
    declaredEmpty: "Hakuna usajili uliotangazwa uliopatikana.",
    declaredEmptyHint: "Usajili uliowasilishwa kikamilifu utaonekana hapa.",
    declaredRetry: "Jaribu tena",
    colNationality: "Uraia",
    colGender: "Jinsia",
    colDob: "Tarehe ya Kuzaliwa",
